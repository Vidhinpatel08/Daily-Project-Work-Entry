        ...
        <>
            <nav className="navbar bg-primary sticky-top d-flex" id='nav-container' data-bs-theme="dark" style={{ color: 'white' }}>
                <div className="d-flex m-1 w-100 " >
                    <div className='border border-2 border-light px-1 mx-1 Navbar_toggle logo_mobile_sidebar'>
                        {!sidebarIsOpen ?
                            <svg xmlns="http://www.w3.org/2000/svg" onClick={logo_click} width="28" height="28" fill="currentColor" className="bi bi-list logo_mobile_sidebar" viewBox="0 0 16 16">
                                <path fillRule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z" />
                            </svg> :
                            <svg xmlns="http://www.w3.org/2000/svg" onClick={logo_click} width="28" height="28" fill="currentColor" className="bi bi-x-lg logo_mobile_sidebar" viewBox="0 0 16 16">
                                <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z" />
                            </svg>
                        }
                    </div>
                    <div className="px-2 " id='nav-container-div' >
                            ...
                            <div className="dropdown px-4 mx-2" id='Navbar-Mobile'>
                                <Link to="/userprofile" className="d-flex align-items-center link-dark text-decoration-none dropdown-toggle" id="dropdownUser2" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <img
                                        src={
                                            typeof image === 'string' ?
                                                ((userProfile.profile === null || userProfile.profile === undefined) ?
                                                    `${imageURL}img/online-learning.jpg` :
                                                    `${imageURL}${userProfile.profile}`) :
                                                (image instanceof Blob ? URL.createObjectURL(image) : `${imageURL}img/online-learning.jpg`)
                                        }
                                        width="32" height="32" className="rounded-circle mx-2 border border-dark"
                                        alt="User Profile"
                                    />
