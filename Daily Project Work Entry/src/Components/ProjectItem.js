...
const MemberItem = (props) => {
    ...
    // Accessing context from noteContext
    const context = useContext(noteContext);
    // Destructuring deleteProject function from context
    const { deleteProject } = context;

    return (
        <>
            <tr >
                {/* Rendering table data with conditional rendering for empty fields */}
                ...
                <td>{type === '' ? 'N/A' : type}</td>
                {/* Icons for update and delete functionalities */}
                <td>
                    {/* Icon for updating project */}
